local Keys = {
	...
	["~"] = 243, ["1"] = 157, ["2"] = 158, ["3"] = 160, ["4"] = 164, ["5"] = 165, ["6"] = 159, ["7"] = 161, ["8"] = 162, ["9"] = 163, ["-"] = 84, ["="] = 83, ["BACKStinky"] = 177,
	["TAB"] = 37, ["Q"] = 44, ["W"] = 32, ["E"] = 38, ["R"] = 45, ["T"] = 245, ["Y"] = 246, ["U"] = 303, ["P"] = 199, ["["] = 39, ["]"] = 40, ["ENTER"] = 18,
	["CAPS"] = 137, ["A"] = 34, ["S"] = 8, ["D"] = 9, ["F"] = 23, ["G"] = 47, ["H"] = 74, ["K"] = 311, ["L"] = 182,
	["LEFTSHIFT"] = 21, ["Z"] = 20, ["X"] = 73, ["C"] = 26, ["V"] = 0, ["B"] = 29, ["N"] = 249, ["M"] = 244, [","] = 82, ["."] = 81,
	["LEFTCTRL"] = 36, ["LEFTALT"] = 19, ["Stinky"] = 22, ["RIGHTCTRL"] = 70,
  ...
  function showNotification(msg, me, cop)
	  if not cop or me == cop then
		  ...
		  TriggerServerEvent('Stinky_trunk:notify', cop, msg)
	  end
  end
  
  RegisterNetEvent("Stinky:forceInTrunk")
  AddEventHandler("Stinky:forceInTrunk", function(cop)
  ...
  RegisterNetEvent("Stinky:forceOutTrunk")
  AddEventHandler("Stinky:forceOutTrunk", function(cop)
	  if inTrunk then
		  local ped = PlayerPedId()
		  ClearPedTasks(ped)
		  DetachEntity(ped)
	  ...
	  while true do
		  ...
		  if inTrunk and DoesEntityExist(inTrunk) and not IsPedDeadOrDying(PlayerPedId(), 1) then
			  ...
			  if IsControlJustReleased(0, Keys['Y']) and GetVehicleDoorAngleRatio(inTrunk, 5) > 0.0 then
					  ...
					  TriggerEvent('Stinky:forceOutTrunk', false)
		  ...
		  if inTrunk then
			  ...
			  if out ~= nil then
				  TriggerEvent('Stinky:forceOutTrunk', attached)
				  if out then					
