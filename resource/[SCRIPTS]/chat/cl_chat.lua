    ...
    while true do
        ...
        for _, player in ipairs(GetActivePlayers()) do
            ...
            if opisy[playerserverid] ~= nil and tostring(opisy[playerserverid]) ~= '' then
                --local playercoords =  GetEntityCoords(Citizen.InvokeNative(0x43A66C31C68491C0,player))
                local playercoords = GetPedBoneCoords(Citizen.InvokeNative(0x43A66C31C68491C0,player), 31086, 0, 0, 0)
