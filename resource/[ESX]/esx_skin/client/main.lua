	...
	while true do
	  ...
	  if cam then
		if IsDisabledControlJustPressed(1, 0) then
		  DeleteSkinCam(true)
		elseif IsControlPressed(0, 63) then
		  angle = angle - 1
		elseif IsControlPressed(0, 64) then
		  angle = angle + 1
		end
...
RegisterNetEvent('esx_skin:openSaveableMenu1')
AddEventHandler('esx_skin:openSaveableMenu1', function(submitCb, cancelCb)
