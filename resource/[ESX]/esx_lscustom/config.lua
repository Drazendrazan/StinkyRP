...
Config.Zones = {
	...
	ls6 = {
		Pos   = { x = 831.625 , y = -885.49, z = 24.25 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {6.0, 16.0, 32.0, 54.0}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.0, 3.0, 6.0, 9.0}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {1.0, 3.0, 6.0, 12.0, 24.0}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {10.0, 20.0, 30.00, 40.00, 50.00, 60.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
