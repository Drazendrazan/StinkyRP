...
Config.ShopsBlips = {
	...
	Mask = {
		Pos = { 
			...
			{ x = 350.523, y = 170.627, z = 102.45 },
			{ x = 460.219, y = -801.843, z = 27.81 },
		},
...
Config.Zones = {
	...
	Mask = {
		Pos = {
			{x = -1338.129, y = -1278.200, z = 3.9},
			{x = 350.523, y = 170.627, z = 102.12},
			{x = 451.219, y = -801.743, z = 26.57},
		}
	},
