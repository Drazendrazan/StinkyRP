...
ESX.RegisterUsableItem('cytryna', function(source)
	...
	TriggerClientEvent('esx_basicneeds:apple', source)
	TriggerClientEvent('esx_status:add', source, 'thirst', 500000)
	TriggerClientEvent('esx:showNotification', source, 'Zjadłeś/aś ~y~Cytryne')
end)
...
ESX.RegisterUsableItem('mandarynka', function(source)
	...
	TriggerClientEvent('esx_basicneeds:apple', source)
	TriggerClientEvent('esx_status:add', source, 'thirst', 500000)
	TriggerClientEvent('esx:showNotification', source, 'Zjadłeś/aś ~o~Mandarynke')
end)
...
ESX.RegisterUsableItem('winogrono', function(source)
	...
	TriggerClientEvent('esx_basicneeds:apple', source)
	TriggerClientEvent('esx_status:add', source, 'thirst', 500000)
	TriggerClientEvent('esx:showNotification', source, 'Zjadłeś/aś ~g~Winogrono')
end)
...
ESX.RegisterUsableItem('brzoskwinia', function(source)
	...
	TriggerClientEvent('esx_basicneeds:apple', source)
	TriggerClientEvent('esx_status:add', source, 'thirst', 500000)
	TriggerClientEvent('esx:showNotification', source, 'Zjadłeś/aś ~o~Brzoskwinie')
end)
...
ESX.RegisterUsableItem('orange', function(source)
	...
	TriggerClientEvent('esx_basicneeds:apple', source)
	TriggerClientEvent('esx_status:add', source, 'thirst', 500000)
	TriggerClientEvent('esx:showNotification', source, 'Zjadłeś/aś ~o~Pomarancze')
end)
...
ESX.RegisterUsableItem('stinkyenergy', function(source)
    TriggerClientEvent('esx_basicneeds:stinkyenergy', source)
    local xPlayer = ESX.GetPlayerFromId(source)
    xPlayer.removeInventoryItem('stinkyenergy', 1)
...
RegisterCommand('heal', function(source, args, user)
	if source == 0 then
		...
		local xPlayer = ESX.GetPlayerFromId(source)
		if xPlayer.group == 'best' or xPlayer.group == 'superadmin' or xPlayer.group == 'admin' or xPlayer.group == 'mod' or xPlayer.group == 'support' or xPlayer.group == 'trailsupport' then
			if args[1] then
