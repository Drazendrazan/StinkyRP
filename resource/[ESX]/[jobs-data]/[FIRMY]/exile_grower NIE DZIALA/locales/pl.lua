Locales['pl'] = {
  ...
  ['wear_work'] = 'strój pracownika Sadu',

  -- skup
  ['sell_menu'] = 'Skup owoców',
  ['sell_prompt'] = 'naciśnij ~INPUT_CONTEXT~ aby otworzyć ~y~sklep~s~.',
  ['sell_pear'] = 'Sprzedaj gruszki',
  ['sell_orange'] = 'Sprzedaj pomarańcze',

  -- przerobka
  ['juice_menu'] = 'Hurtownia soków',
  ['juice_work'] = 'naciśnij ~INPUT_CONTEXT~ aby otworzyć ~y~menu hurtownii~s~.',
  ['juice_prompt'] = 'naciśnij ~INPUT_CONTEXT~ aby otworzyć ~y~menu hurtownii~s~.',
  ['juice_maker'] = 'Przerób owoce na sok <span style="color:red">KOSZT: 1$</span>',
