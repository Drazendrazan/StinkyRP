...
RegisterServerEvent('esx_mecanojob:giveItemtakichuj')
AddEventHandler('esx_mecanojob:giveItemtakichuj', function(itemName)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name ~= 'mecano' then
		print(('esx_mecanojob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	elseif (itemName ~= 'gazbottle') and (itemName ~= 'fixtool') and (itemName ~= 'carotool') and (itemName ~= 'blowpipe') and (itemName ~= 'fixkit') and (itemName ~= 'carokit') and (itemName ~= 'gps') then
		print(('esx_mecanojob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
