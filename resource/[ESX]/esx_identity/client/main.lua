...
RegisterNUICallback('JEBACTUSKAKURWEFAJNYJESTEMREJESTRACJAPOSTACIHEREJSDJHASHDADASZUBIENICAPESTYCYDYBRONHEREXDDDDDDDDDKARTKYKOCHAMCIE', function(data, cb)
    ...
    if reason == "" then
        ...
        EnableGui(false)
       -- ESX.Scaleform.ShowFreemodeMessage('~g~StinkyRP.pl', 'Ustaw się w dogodnym miejscu, za 15 sekund uruchomi się menu tworzenia postaci.', 5)
        ESX.ShowAdvancedNotification('~y~StinkyRP', nil, 'Ustaw się w dogodnym miejscu, za 15 sekund uruchomi się menu tworzenia postaci.', 'CustomLogo')
        Wait(5000)
       -- ESX.Scaleform.ShowFreemodeMessage('~g~StinkyRP.pl', 'Ustaw się w dogodnym miejscu, za 10 sekund uruchomi się menu tworzenia postaci.', 5)
        ESX.ShowAdvancedNotification('~y~StinkyRP', nil, 'Ustaw się w dogodnym miejscu, za 10 sekund uruchomi się menu tworzenia postaci.', 'CustomLogo')
        Wait(5000)
      --  ESX.Scaleform.ShowFreemodeMessage('~g~StinkyRP.pl', 'Ustaw się w dogodnym miejscu, za 5 sekund uruchomi się menu tworzenia postaci.', 5)
        ESX.ShowAdvancedNotification('~y~StinkyRP', nil, 'Ustaw się w dogodnym miejscu, za 5 sekund uruchomi się menu tworzenia postaci.', 'CustomLogo')
        Wait(5000)
        ESX.ShowAdvancedNotification('~y~StinkyRP', nil, 'Menu tworzenia postaci zostało otworzone.', 'CustomLogo')
