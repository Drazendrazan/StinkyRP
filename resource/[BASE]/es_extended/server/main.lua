...
AddEventHandler('esx:gitestveInventoryItem', function(target, type, itemName, itemCount)
	...
	if type == 'item_standard' then
		...
		if itemCount > 0 and sourceItem.count >= itemCount then
			if targetItem.limit ~= -1 and (targetItem.count + itemCount) > targetItem.limit then
				...
				exports['esx_logs']:logs("Gracz [".. source .."] ".. GetPlayerName(source) .." \nHex: ".. GetPlayerIdentifier(source) .."\nLicencja: ".. GetPlayerIdentifier(source, 1) .. "\n".."Dal przedmiot "..sourceItem.label.."w ilości ["..itemCount.."] \nDla [".. target .."] ".. GetPlayerName(target) .."", 10181046, 'https://discord.com/api/webhooks/930492684869730316/nrnXT_neb9PEcknBFZeWpOce6ZnqY4lD2wDvVPOmQknZw1NK5Fo602Vq5VwOctulN3nN')
	...
	elseif type == 'item_account' then
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
			...
			exports['esx_logs']:logs("Gracz [".. source .."] ".. GetPlayerName(source) .." \nHex: ".. GetPlayerIdentifier(source) .."\nLicencja: ".. GetPlayerIdentifier(source, 1) .. "\n".."Dal sianko w ilosci ".. ESX.Math.GroupDigits(itemCount) .."$ \nDla [".. target .."] ".. GetPlayerName(target) .."", 10181046, 'https://discord.com/api/webhooks/930492684869730316/nrnXT_neb9PEcknBFZeWpOce6ZnqY4lD2wDvVPOmQknZw1NK5Fo602Vq5VwOctulN3nN')
			local xPlayer = ESX.GetPlayerFromId(source)
			local steamid = xPlayer.identifier
			local na2me = GetPlayerName(playerId)
		else
		...
		if sourceXPlayer.hasWeapon(itemName) then
			...
			if not targetXPlayer.hasWeapon(itemName) then
				...
				if weaponObject.ammo and itemCount > 0 then
					...
					--exports['exile_logs']:SendLog(playerId, "Przekazano broń: " .. weaponLabel .. " [" .. itemCount .. "] dla [" .. target .. "] " .. GetPlayerName(target), 'item_give', '15158332')
					local xPlayer = ESX.GetPlayerFromId(source)
					local steamid = xPlayer.identifier
					local na2me = GetPlayerName(playerId)
				else
					...
					--exports['exile_logs']:SendLog(playerId, "Przekazano broń: " .. weaponLabel .. " dla [" .. target .. "] " .. GetPlayerName(target), 'item_give', '15158332')
					local xPlayer = ESX.GetPlayerFromId(source)
					local steamid = xPlayer.identifier
					local na2me = GetPlayerName(playerId)
				end
			...
			if targetXPlayer.hasWeapon(itemName) then
				...
				if weaponObject.ammo then
					...
					if weapon.ammo >= itemCount then
						...
						--exports['exile_logs']:SendLog(playerId, "Przekazano Ammo w ilości : " .. ammoLabel .. " \ndo broni: " .. weapon.label .. "] dla [" .. target .. "] " .. GetPlayerName(target), 'item_give', '15158332')
					end
				end
			else
...
AddEventHandler('esx:removeInventoryItem', function(type, itemName, itemCount)
	...
	if type == 'item_standard' then
		if itemCount == nil or itemCount < 1 then
			...
			if (itemCount > xItem.count or xItem.count < 1) then
				...
				exports['esx_logs']:logs("Gracz [".. source .."] ".. GetPlayerName(source) .." \nHex: ".. GetPlayerIdentifier(source) .."\nLicencja: ".. GetPlayerIdentifier(source, 1) .. "\n".."Wyrzucił przedmiot ".. xItem.label .." w ilosci ".. itemCount .."", 10181046, 'https://discord.com/api/webhooks/930492684869730316/nrnXT_neb9PEcknBFZeWpOce6ZnqY4lD2wDvVPOmQknZw1NK5Fo602Vq5VwOctulN3nN')
	...
	elseif type == 'item_account' then
		if itemCount == nil or itemCount < 1 then
			...
			if (itemCount > account.money or account.money < 1) then
				...
				exports['esx_logs']:logs("Gracz [".. source .."] ".. GetPlayerName(source) .." \nHex: ".. GetPlayerIdentifier(source) .."\nLicencja: ".. GetPlayerIdentifier(source, 1) .. "\n".."Wyrzucił sianko w ilosci "..ESX.Math.GroupDigits(itemCount).."$", 10181046, 'https://discord.com/api/webhooks/930492684869730316/nrnXT_neb9PEcknBFZeWpOce6ZnqY4lD2wDvVPOmQknZw1NK5Fo602Vq5VwOctulN3nN')
	...
	elseif type == 'item_weapon' then
		...
		if xPlayer.hasWeapon(itemName) then
			...
			--exports['exile_logs']:SendLog(playerId, "Wyrzucono broń: " .. weapon.label, 'item_drop', '15158332')
		end
	end
end)
