...
RegisterNetEvent('niemiecki216-dodatki:powiekszonymagazynek')
AddEventHandler('niemiecki216-dodatki:powiekszonymagazynek', function(duration)
...
RegisterNetEvent('niemiecki216-dodatki:kompensator')
AddEventHandler('niemiecki216-dodatki:kompensator', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kompensator = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:MountedScope')
AddEventHandler('niemiecki216-dodatki:MountedScope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:yusuf')
AddEventHandler('niemiecki216-dodatki:yusuf', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local yusuf = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:celownikdluga')
AddEventHandler('niemiecki216-dodatki:celownikdluga', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:vipskinmotyl')
AddEventHandler('niemiecki216-dodatki:vipskinmotyl', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:kastetpink')
AddEventHandler('niemiecki216-dodatki:kastetpink', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetpink = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:mediumscope')
AddEventHandler('niemiecki216-dodatki:mediumscope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local mediumscope = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:largescope')
AddEventHandler('niemiecki216-dodatki:largescope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local largescope = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:holografik')
AddEventHandler('niemiecki216-dodatki:holografik', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local holografik = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:platin50')
AddEventHandler('niemiecki216-dodatki:platin50', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local platin50 = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:woodheavyp')
AddEventHandler('niemiecki216-dodatki:woodheavyp', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local woodheavyp = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:wooddlugie')
AddEventHandler('niemiecki216-dodatki:wooddlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local wooddlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:czaszkidlugie')
AddEventHandler('niemiecki216-dodatki:czaszkidlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:zebradlugie')
AddEventHandler('niemiecki216-dodatki:zebradlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local zebradlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:boomdlugie')
AddEventHandler('niemiecki216-dodatki:boomdlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local boomdlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:tactitalmuzle')
AddEventHandler('niemiecki216-dodatki:tactitalmuzle', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:kastetpimp')
AddEventHandler('niemiecki216-dodatki:kastetpimp', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetpimp = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:kastetbalas')
AddEventHandler('niemiecki216-dodatki:kastetbalas', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetbalas = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:kastetdollar')
AddEventHandler('niemiecki216-dodatki:kastetdollar', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:kastetdiament')
AddEventHandler('niemiecki216-dodatki:kastetdiament', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:kastethate')
AddEventHandler('niemiecki216-dodatki:kastethate', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastethate = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:kastetplayer')
AddEventHandler('niemiecki216-dodatki:kastetplayer', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('niemiecki216-dodatki:kastetvagos')
AddEventHandler('niemiecki216-dodatki:kastetvagos', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetvagos = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:grip')
AddEventHandler('niemiecki216-dodatki:grip', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local grip = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:Suppressor')
AddEventHandler('niemiecki216-dodatki:Suppressor', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local Suppressor = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('niemiecki216-dodatki:flashlight')
AddEventHandler('niemiecki216-dodatki:flashlight', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local flashlight = 0
					for i=1, #inventory, 1 do
