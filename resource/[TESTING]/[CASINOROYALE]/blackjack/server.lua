...
AddEventHandler('route68_blackjack:removemoney', function(amount)
	...
	TriggerClientEvent('esx:showNotification', _source, 'Postawiles ' .. amount .. ' zetonow!')
...
AddEventHandler('route68_blackjack:givemoney', function(amount, multi)
	...
	if multi == 2 then
		TriggerClientEvent('esx:showNotification', _source, 'Wygrales ' .. win .. ' zetonow!')
		--TriggerClientEvent('pNotify:SendNotification', _source, {text = "You won "..win.." chips! Good job!"})
	elseif multi == 1 then
		TriggerClientEvent('esx:showNotification', _source, 'Przegrales ' .. win .. ' zetonow!')
