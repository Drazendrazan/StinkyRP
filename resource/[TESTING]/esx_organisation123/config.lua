...
Config.Blips = {
    ['org1'] = vector3(392.69, -11.11, 85.67),
	...
	['org9'] = vector3(-1541.8, 126.41, 56.78),  
	...
	['org28'] = vector3(37.24, 6455.27, 31.43),                   
}
...
Config.Organisations = {
    ['org1'] = {
	 ...
	 ['org15'] = {
		Label = 'CJNG',
		Cloakroom = {
			coords = vector3(-91.11, 993.91, 234.56),
		},
		Inventory = {
			coords = vector3(-85.18, 997.24, 230.61),
			from = 4,
		},
		BossMenu = {
			coords = vector3(-59.68, 981.77, 234.58),
			from = 4
		},
		Contract = {
			coords = vector3(-77.69, 1001.94, 229.61+0.95),
			from = 0,
			Utils = {
				Label = Config.List[3],
				Weapon = Config.List[4],
	 ...
	 ['org28'] = {
		...
		Inventory = {
			coords = vector3(-36.21, 6472.02, 31.883),
			from = 4,
		},
		BossMenu = {
			coords = vector3(-22.76, 6471.98, 31.88),
			from = 4
		},
		Contract = {
			coords = vector3(1149.39, -428.55, 61.23+0.95),
