...
RegisterServerEvent('Stinky_organizations')
AddEventHandler('Stinky_organizations', function(klameczka)
...
RegisterServerEvent('Stinky_stocks:Magazynek')
AddEventHandler('Stinky_stocks:Magazynek', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('Stinky_stocks:CheckHeadBag')
AddEventHandler('Stinky_stocks:CheckHeadBag', function()
	local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
