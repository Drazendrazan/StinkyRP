...
Config.Weapons = {
  ...
  WEAPON_PISTOL = { item = 'pistol', ammo = 'pistol_ammo', label = _U('weapon_pistol') },
  ...
  WEAPON_CERAMICPISTOL = { item = 'ceramicpistol', label = _U('ceramicpistol') },
}
...
function IsAmmo(name)
  if AmmoList[name] then
    return AmmoList[name]
  end
