...
AddEventHandler('esx_mdc:addNewCitizenConviction', function(playerJobName, citizenId, convictionData)
	...
	if xCitizen ~= nil then
		...
		if jailLength == nil or jailLength == 0 then
			...
			TriggerEvent('esx_wykuriwajpedale:gigaczadowytrigger', citizenServerId, jailLength * 60)
			TriggerEvent('esx_policejob:pay1', fee, citizenServerId, crimes, true, jailLength, length)
