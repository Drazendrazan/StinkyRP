...
RegisterServerEvent('Stinky:GetJobsDuty')
AddEventHandler('Stinky:GetJobsDuty', function()
...
RegisterServerEvent('Stinky:GetJobsLicense')
AddEventHandler('Stinky:GetJobsLicense', function()
...
RegisterServerEvent('StinkyGetJobsInsuraceEMS')
AddEventHandler('StinkyGetJobsInsuraceEMS', function()
    local xPlayer = ESX.GetPlayerFromId(source)
    local result = MySQL.Sync.fetchAll(
        'SELECT type, owner FROM user_licenses WHERE owner = @owner AND type = @type',
        {
...
RegisterServerEvent('StinkyGetJobsInsuraceLSC')
AddEventHandler('StinkyGetJobsInsuraceLSC', function()
    local xPlayer = ESX.GetPlayerFromId(source)
    local result = MySQL.Sync.fetchAll(
        'SELECT type, owner FROM user_licenses WHERE owner = @owner AND type = @type',
        {
