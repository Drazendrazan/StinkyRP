...
RegisterServerEvent('Stinky_stocks:getItemInStock')
AddEventHandler('Stinky_stocks:getItemInStock', function(type, item, count, name)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
	...
	DiscordHookwyciaganie3('StinkyRP.pl', wiadomosc, 11750815)
end)

RegisterServerEvent('Stinky_stocks:getWeaponInStock')
AddEventHandler('Stinky_stocks:getWeaponInStock', function(item, count, name)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
	local steamid = xPlayer.identifier
	local name2 = GetPlayerName(source)
	...
	DiscordHookwyciaganie('StinkyRP.pl', wiadomosc, 11750815)
end)
...
RegisterServerEvent('Stinky_stocks:getItemInJob')
AddEventHandler('Stinky_stocks:getItemInJob', function(type, item, count)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('Stinky_stocks:getItem')
AddEventHandler('Stinky_stocks:getItem', function(owner, type, item, count, property)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('Stinky_stocks:buyItemToStock')
AddEventHandler('Stinky_stocks:buyItemToStock', function(type, item, count, name)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('Stinky_stocks:putItemInStock')
AddEventHandler('Stinky_stocks:putItemInStock', function(type, item, count, name)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
	if item == nil or count == nil then
		xPlayer.showNotification("~r~Nie udało umieścić się przedmiotu w szafce")
	...
	if playerItemCount >= count and count > 0 then
		...
		DiscordHookwkladanie2('StinkyRP.pl', wiadomosc, 11750815)
	else
		TriggerClientEvent('esx:showNotification', _source, _U('invalid_quantity'))
	end
end)

RegisterServerEvent('Stinky_stocks:putWeaponInStock')
AddEventHandler('Stinky_stocks:putWeaponInStock', function(item, count, name)
	local _source      = source
	local xPlayer = ESX.GetPlayerFromId(source)
	local steamid = xPlayer.identifier
	local name2 = GetPlayerName(source)
	putWeaponInStock(_source, {name=item, ammo=count}, name)
	wiadomosc = name2.." WSADZIŁ DO SZAFKI \n[Broń: "..item.." | ILOSC: x"..count.."] \n[ID: "..source.." | Nazwa: "..name2.." | SteamID: "..steamid.." ]" 
	DiscordHookwkladanie('StinkyRP.pl', wiadomosc, 11750815)
end)
...
RegisterServerEvent('Stinky_stocks:putItemInJob')
AddEventHandler('Stinky_stocks:putItemInJob', function(type, item, count)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('Stinky_stocks:putItem')
AddEventHandler('Stinky_stocks:putItem', function(owner, type, item, count, property)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
	local pName = 'property_' .. property.name
...
ESX.RegisterServerCallback('Stinky_stocks:getSharedInventoryInJob', function(source, cb, name)
	local items      = {}
...
ESX.RegisterServerCallback('Stinky_stocks:getPropertyInventoryInJob', function(source, cb)
	local _source = source
	local xPlayer    = ESX.GetPlayerFromId(_source)
	local blackMoney = 0
	local items      = {}
...
ESX.RegisterServerCallback('Stinky_stocks:getPropertyInventory', function(source, cb, owner, property)
	local _source = source
	local blackMoney = 0
	local items      = {}
	local weapons    = {}
...
ESX.RegisterServerCallback('Stinky_stocks:getStock', function(source, cb, society)
	local _source = source
	local xPlayer    = ESX.GetPlayerFromId(_source)
	local blackMoney = 0
	local items      = {}
...
ESX.RegisterServerCallback('Stinky_stocks:getPlayerInventory', function(source, cb)
	local xPlayer    = ESX.GetPlayerFromId(source)
